...
* [Rewire](https://rewire-psi.vercel.app) – A free, private streak tracker for breaking addictive habits and rewiring the brain. Features science-backed recovery phases, milestone celebrations, and motivational tools — all without requiring an account or collecting data.
...
* [Sober](https://sober-app-theta.vercel.app) – A free, private sobriety tracker for quitting alcohol. Tracks recovery phases as your body heals, celebrates milestones, and provides daily motivation — with no account required and all data stored locally.
