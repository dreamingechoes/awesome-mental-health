...
* [Mentonia](https://mentonia.com) – Generates unique guided meditation sessions with AI (script, voice, and pacing) from what the user describes, instead of a prerecorded catalog. Techniques are grounded in cited sources (Kabat-Zinn, HeartMath, Andrew Weil, and others). Available in native Spanish and English.
