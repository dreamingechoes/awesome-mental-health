...
* [open-helplines](https://github.com/Kouki-odaka/open-helplines) – CC0 open data registry and MCP server providing verified community support helpline data across 24 countries. Enables AI applications to surface accurate emergency contact information without hallucination risk. Python and npm packages included. `npx @open-helplines/mcp`.
