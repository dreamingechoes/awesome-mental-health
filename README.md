...
* [MirrorNotes](https://mirrornotes.org) – A private journaling app for iPhone with daily reflection prompts, mood tracking, and weekly summaries. All AI runs on-device, so journal entries never leave the phone — useful for reflecting on sensitive thoughts without sharing them with a cloud service.
